...
function OrderdetailRemove() {
    ...
    useEffect(function () {
        (async function () {
            await orderdetailservice.getListRemove(8, page).then(function (result) {
    ...
    return ( 
        <div className="card">
             <div className="card-header">
                <div className="row">
                    <div className="col-6">
                    <Link to="/admin/orderdetail"><strong className="text-primary">CHI TIẾT ĐƠN HÀNG</strong></Link>
                        </div>
                    ...
                    {orderdetails.map(function(orderdetail,index){
                        ...
                        <tr key={index}>
                            ...
                            <td>
                               ...
                               <FaEye/> </Link>
                               <button onClick={() => orderdetaiRestore(orderdetail.id)} className="btn btn-sm btn-danger me-1">
...
export default OrderdetailRemove;