...
function CategoryRemove() {
    ...
    useEffect(function () {
        (async function () {
            await categoryservice.getListRemove(5, page).then(function (result) {
                ...
                <div className="row">
                    <div className="col-6">
                        <Link to="/admin/category">
                            <strong className="text-primary">DANH MỤC SẢN PHẨM</strong></Link>
                        </div>
                    ...
                    {categories.map(function(category,index){
                        ...
                        <tr key={index}>
                            ...
                            <td>
                               ...
                               <FaEye/> </Link>
                               <button onClick={() => categoryRestore(category.id)} className="btn btn-sm btn-dange me-1r">
