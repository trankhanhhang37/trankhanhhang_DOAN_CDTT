...
function MenuRemove() {
    ...
    useEffect(function () {
        (async function () {
            await menuservice.getListRemove(5, page).then(function (result) {
    ...
    return ( 
        <div className="card">
             <div className="card-header">
                <div className="row">
                    <div className="col-6">
                    <Link to="/admin/menu"><strong className="text-primary">MENU</strong></Link>
                        </div>
                    ...
                    {menus.map(function(menu,index){
                        ...
                        <tr key={index}>
                            ...
                            <td>
                               ...
                               <FaEye/> </Link>
                               <button onClick={() => menuRestore(menu.id)} className="btn btn-sm btn-danger me-1">
